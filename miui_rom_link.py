...
if __name__ == '__main__':
    ...
    rom_version = "stable"
    # step 1: create MIUI_ROM object
    miui_rom=MIUI_ROM()
    # step 2: get rom link list by query_link()
    rom_link_list = miui_rom.query_link(model_name,region,rom_cleases,rom_version)
    # step 3: print rom link
